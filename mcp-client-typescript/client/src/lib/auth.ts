...
class ExampleOAuthClientProvider implements OAuthClientProvider {
  ...
  get clientMetadata() {
    return {
      ...
      response_types: ["code"],
      client_name: "MCP Example TypeScript Client",
      client_uri: "https://github.com/modelcontextprotocol/quickstart",
    };
  }
...
export const authProvider = new ExampleOAuthClientProvider();
